...
@section('content')
    ...
    <form action="{{route('agreement.update',$agreement->id)}}" method="POST" enctype="multipart/form-data" class="mb-5">
        ...
        <input type="text" class="form-control" id="start" name="start" value="{{$agreement->start}}">
        ...
        <input type="text" class="form-control" id="end" name="end" value="{{$agreement->end}}">
        ...
        <div class="form-group">
            <h3 class="text-danger">CONDITIONS:  </h3>
