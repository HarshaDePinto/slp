...
@section('content')
        ...
        <form action="{{route('vehicles.store')}}" method="POST" enctype="multipart/form-data" class="mb-5">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="sMilage" required>
            </div>

            <div class="form-group">
                <label class="font-weight-bold" for="next_service">Next Service</label>
                <input type="text" class="form-control" name="next_service" placeholder="in km " required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="gear_oil_change" placeholder="km" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="license_exp" name="license_exp" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="insurance_exp" name="insurance_exp" required>
            </div>
