                            ...
                            @if ($tour->start<=date('Y-m-d H:i:s') && $tour->end>=date('Y-m-d H:i:s') && $tour->status==1 )
                                @if ($tour->user_id==$user->id)
                                    @if ($tour->expenses()->count()!=0)
                                        <h4 class="text-success">Other Expenses</h4>
                                        <form action="{{route('expenses.store')}}" method="POST" enctype="multipart/            form-data"class="mb-5">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="tour" value="{{ $tour->id}}" hidden >
                                                                                                                ...
                                                                                                                <div class="form-group">
                                            <label class="font-weight-bold" for="name">Details</label>
